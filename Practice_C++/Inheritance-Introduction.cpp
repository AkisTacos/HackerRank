...
/* Description:
	...
	The class Triangle has a function called triangle(). 
	Now we create a class derived from the base class Triangle called Isosceles.
	...
	Now we can create a derived class object and use it to access the functions 
	of the base class.
